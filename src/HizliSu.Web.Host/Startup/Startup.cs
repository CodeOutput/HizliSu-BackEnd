...
namespace HizliSu.Web.Host.Startup
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            //var nfInfo = new System.Globalization.CultureInfo("tr-TR", false)
            //{
            //    NumberFormat =
            //    {
            ...
            return services.AddAbp<HizliSuWebHostModule>(
        ...
        public void Configure(IApplicationBuilder app,  ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(options =>
            {
                ...
                options.SwaggerEndpoint($"/swagger/{_apiVersion}/swagger.json", $"HizliSu API {_apiVersion}");
                options.IndexStream = () => Assembly.GetExecutingAssembly()
                    .GetManifestResourceStream("HizliSu.Web.Host.wwwroot.swagger.ui.index.html");
