...
namespace HizliSu.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly HizliSuDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = HizliSuConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(HizliSuDbContext context)
        {
            _context = context;
        }
