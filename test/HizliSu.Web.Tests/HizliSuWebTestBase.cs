...
using HizliSu.Models.TokenAuth;
...
{
    public abstract class HizliSuWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static HizliSuWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(HizliSuWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<HizliSuDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<HizliSuDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<HizliSuDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<HizliSuDbContext, Task<T>> func)
        {
            T result;
